    ...
    <article class="index__article">
        <section class="index__article__section1">
            ...
            <div class="index__carousel">
                ...
                <div id="carouselExample" class="carousel slide index__carousel__in">
                    <div class="carousel-inner">
                            ...
                            <div class="card mb-3" style="max-width: 600px; min-width: 600px">
                                <div class="row g-0">
                                    <div class="col-md-4 index__carousel__card__img">
                                        <img src="contenido/img/landing/Libro2.jpg" class="img-fluid rounded-start"
                                            alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                        ...
                        <div class="carousel-item index__carousel__card">
                            <div class="card mb-3" style="max-width: 600px; min-width: 600px">
                                <div class="row g-0">
                                    <div class="col-md-4 index__carousel__card__img">
                                        <img src="contenido/img/landing/Libro3.jpg" class="img-fluid rounded-start"
                                            alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
            ...
            <div class="card-group card index__article__section2__c-group">
                ...
                <div class="d-flex justify-content-center index__article__section2__card">
                    <div class="card" style="width: 20rem;">
                        <img src="contenido/img/landing/Libro2.jpg" class="card-img-top" alt="mapa_avatar">
                        <div class="card-body">
                ...
                <div class="d-flex justify-content-center index__article__section2__card">
                    <div class="card" style="width: 20rem;">
                        <img src="contenido/img/landing/Libro3.jpg" class="card-img-top" alt="mapa_avatar">
                        <div class="card-body">
                            <h5 class="card-title display-5 text-center">Nombre libro</h5>
                            <p class="card-text">This card has supporting text below as a natural lead-in to additional
                                content.</p>
